...
<div id="msg" class="errors">
    ...
    <p>You are currently accessing Integral over a non-secure connection.  Single Sign On WILL NOT WORK.  In order to have single sign on work, you MUST log in over HTTPS.</p>
</div>
</c:if>
