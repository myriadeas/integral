...
@Import(value = { JpaInfrastructureConfigStaging.class,
		...
		IntegralCirculationConfigStaging.class })
...
@ComponentScan(basePackages = { "my.com.myriadeas.integral.marc",
		...
		"my.com.myriadeas.integral.security",
		"my.com.myriadeas.integral.circulation",
		"my.com.myriadeas.integral.holiday",
...
public class IntegralVufindConfigStaging implements IntegralCataloguingConfig {
