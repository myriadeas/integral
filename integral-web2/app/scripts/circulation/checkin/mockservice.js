		...
		return {
			...
			getItemInformation: function(itemIdentifier, circulationIdentifier){
				...
				if (itemIdentifier == "001"){
					...
					response = ServicesRestangular.one('circulation/checkin/item/information/itemInformation.json').get({XXitemIdentifier: itemIdentifier, cicircIdentifier: circulationIdentifier});
				}
				return response;
			}
		};
