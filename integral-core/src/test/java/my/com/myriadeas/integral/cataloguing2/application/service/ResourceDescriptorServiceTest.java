...
import my.com.myriadeas.integral.cataloguing2.presentation.SqlResourceDescriptorFinder;
...
public class ResourceDescriptorServiceTest {
	...
	@Autowired
	SqlResourceDescriptorFinder rdFinder;
	...
	@Test
	public void testResourceDescriptorReadService() throws Exception {

		VerifyResourceDescriptorCommand verifyResourceDescriptorCommand = new VerifyResourceDescriptorCommand(
				record);
		System.out.println(resourceDescriptorReadService
