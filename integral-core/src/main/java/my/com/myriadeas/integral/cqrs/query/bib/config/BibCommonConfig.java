package my.com.myriadeas.integral.cqrs.query.bib.config;
...
@ComponentScan(basePackages = { "my.com.myriadeas.integral.core",
		"my.com.myriadeas.integral.cqrs.query.bib",
		"my.com.myriadeas.integral.internalization" }, excludeFilters = { @Filter(Configuration.class) })
@ImportResource(value = { "classpath:META-INF/spring/queryBibServiceRouteContext.xml" })
@EnableSpringConfigured
@Configuration
@EnableTransactionManagement
public class BibCommonConfig {
