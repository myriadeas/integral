...
public class ResourceDescriptorDeleted implements DomainEvent {
	
	private String resourceDescriptorId;

	public ResourceDescriptorDeleted(String resourceDescriptorId) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ResourceDescriptorDeleted other = (ResourceDescriptorDeleted) obj;
