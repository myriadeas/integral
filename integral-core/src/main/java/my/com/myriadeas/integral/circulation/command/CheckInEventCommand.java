...
public class CheckInEventCommand {

	private Item item;

	private CirculationTransaction circulationTransaction;

	public CheckInEventCommand(Item item, CirculationTransaction circulationTransaction) {
		this.item = item;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CheckInEventCommand other = (CheckInEventCommand) obj;
	...
	public String toString() {
		return "CheckInEventCommand [item=" + item
