...
public class AvailableItemStatusForCheckOutException extends
		IntegralCirculationException {

	private static final long serialVersionUID = 1L;

	private static final String messageId = "circulation.availableItemStatusForCheckOut";

	public AvailableItemStatusForCheckOutException(String message,
			Object... arguments) {
