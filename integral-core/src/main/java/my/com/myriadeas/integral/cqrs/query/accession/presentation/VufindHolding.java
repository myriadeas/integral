...
public class VufindHolding {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VufindHolding other = (VufindHolding) obj;
	...
	public String toString() {
		return "VufindHolding [id=" + id + ", availability=" + availability
				+ ", status=" + status + ", location=" + location
				+ ", reserve=" + reserve + ", callnumber=" + callnumber
				+ ", duedate=" + duedate + ", returnDate=" + returnDate
				+ ", number=" + number + ", requests_placed=" + requests_placed
				+ ", barcode=" + barcode + ", notes=" + notes + ", summary="
				+ summary + ", supplements=" + supplements + ", indexes="
				+ indexes + ", is_holdable=" + is_holdable + ", holdtype="
				+ holdtype + ", item_id=" + item_id + ", holdOverride="
				+ holdOverride + "]";
	}
