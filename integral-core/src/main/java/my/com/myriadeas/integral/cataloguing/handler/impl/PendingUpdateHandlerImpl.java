...
@Service("pendingUpdateHandler")
public class PendingUpdateHandlerImpl {
	private static final Logger logger = LoggerFactory
			.getLogger(PendingUpdateHandlerImpl.class);
	...
	public void handle(Record record) {
		...
		if (material.isPendingIndex()){
			indexService.index(record, materialNo);
			material.setStatus(CataloguingStatusEnum.INDEXED);
