...
public class CompletedRdso implements ResourceDescriptorStatusOperations {
	...
	public ResourceDescriptorStatus revise(ResourceDescriptor rd, String marc,
		...
		rd.setMarc(marc);
		DomainEvent event = new ResourceDescriptorRevised(
				rd.getResourceDescriptorId());
		events.put("resourceDescriptorRevised", event);
