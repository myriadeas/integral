...
import my.com.myriadeas.integral.assetmanagement.domain.assembler.CreateItemMapper;
import my.com.myriadeas.integral.assetmanagement.domain.assembler.DeleteItemMapper;
import my.com.myriadeas.integral.assetmanagement.domain.assembler.ReceiveItemMapper;
import my.com.myriadeas.integral.assetmanagement.domain.assembler.ReleaseItemMapper;
import my.com.myriadeas.integral.assetmanagement.domain.assembler.UnreleaseItemMapper;
...
public class ItemFacadeImpl implements ItemFacade {
	...
	private static final Logger logger = org.slf4j.LoggerFactory
			.getLogger(ItemFacadeImpl.class);
	...
	public ReceiveItemResponse receiveItem(ReceiveItemRequest receiveItemRequest) {
		...
		itemWriteService.receiveItem(receiveItemCommand);
	...
	public CreateItemResponse createItem(CreateItemRequest createItemRequest) {
		...
		Long id = itemWriteService.createItem(createItemCommand);
	...
	public ReleaseItemResponse releaseItem(ReleaseItemRequest releaseItemRequest) {
		...
		logger.info("Release Item Identifier={}",
				releaseItemRequest.getItemIdentifier());
		Long id = itemWriteService.releaseItem(releaseItemCommand);
	...
	public UnreleaseItemResponse unreleaseItem(
		...
		Long id = itemWriteService.unreleaseItem(unreleaseItemCommand);
	...
	public DeleteItemResponse deleteItem(DeleteItemRequest deleteItemRequest) {
		...
		Long id = itemWriteService.deleteItem(deleteItemCommand);
