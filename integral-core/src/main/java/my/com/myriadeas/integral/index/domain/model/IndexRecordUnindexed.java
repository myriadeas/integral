...
public class IndexRecordUnindexed implements DomainEvent {
	
	private String resourceDescriptorId;

	public IndexRecordUnindexed(String resourceDescriptorId) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IndexRecordUnindexed other = (IndexRecordUnindexed) obj;
