...
public class ResourceDescriptorUpdated implements DomainEvent {
	
	private String resourceDescriptorId;

	public ResourceDescriptorUpdated(String resourceDescriptorId) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ResourceDescriptorUpdated other = (ResourceDescriptorUpdated) obj;
