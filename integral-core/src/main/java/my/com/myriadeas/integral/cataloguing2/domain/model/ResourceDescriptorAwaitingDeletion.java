...
public class ResourceDescriptorAwaitingDeletion implements DomainEvent {
	
	private String resourceDescriptorId;

	public ResourceDescriptorAwaitingDeletion(String resourceDescriptorId) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ResourceDescriptorAwaitingDeletion other = (ResourceDescriptorAwaitingDeletion) obj;
