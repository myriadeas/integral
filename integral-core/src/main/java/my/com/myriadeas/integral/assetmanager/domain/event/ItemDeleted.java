...
public class ItemDeleted implements DomainEvent {
	...
	public ItemDeleted(String itemIdentifier) {
		super();
		this.itemIdentifier = itemIdentifier;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ItemDeleted other = (ItemDeleted) obj;
	...
	public String toString() {
		return "ItemDeleted [itemIdentifier=" + itemIdentifier + "]";
	}
